...
function TermsOfService() {
  return (
    <Page title="Terms of Service" description="Terms of Service">
      {/* <TopNavbar /> */}
      <div className={styles.termsOfService}>
        <h2>Flavor AI Terms of Service</h2>
        <p>
          These Terms of Service govern your use of the website located at{" "}
          <a href="https://getflavor.ai/">https://getflavor.ai/</a> and any
          related services provided by Flavor AI.{" "}
        </p>
        <p>
          By accessing <a href="https://getflavor.ai/">https://getflavor.ai/</a>
          ...
          using any other services provided by Flavor AI.{" "}
        </p>
        <p>
          We, Flavor AI, reserve the right to review and amend any of these
        ...
        <p>These Terms of Service were last updated on 26 June 2023. </p>
        ...
        <p>
          ...
          are owned by or licensed to Flavor AI and are protected by applicable
        ...
        <p>
          ...
          restrictions or the Terms of Service, and may be terminated by Flavor
          AI at any time.{" "}
        </p>
        <h3>Liability</h3>
        <p>
          Our website and the materials on our website are provided on an 'as
          is' basis. To the extent permitted by law, Flavor AI makes no
        ...
        <p>
          ...
          on this website, even if Flavor AI or an authorized representative has
        ...
        <p>
          ...
          for general information purposes only. Flavor AI does not warrant or
        ...
        <h3>Links</h3>
        <p>
          Flavor AI has not reviewed all of the sites linked to its website and
          is not responsible for the contents of any such linked site. The
          inclusion of any link does not imply endorsement, approval, or control
          by Flavor AI of the site. Use of any such linked site is at your own
        ...
        <p>
          ...
          with the laws of USA. You irrevocably submit to the exclusive
