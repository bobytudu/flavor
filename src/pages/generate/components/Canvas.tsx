...
function Canvas({
  ...
  const deleteSelectedObject = () => {
    ...
    if (activeObject && activeObject.imageType !== "productImage") {
      ...
      if (selectedObjectIndex !== -1) {
        ...
        canvas.renderAll();
        const getAllImageObject = canvas
          .getObjects()
    ...
    reader.onload = () => {
      ...
      img.onload = () => {
        ...
        fabricImage.set({
          ...
          imgWidth: canvasConfig.containerWidth,
          imgHeight: canvasConfig.containerHeight,
  ...
  const handleUndo = () => {
    const objects = canvas.getObjects();
    const rectangleIndex = objects.findIndex(
      (obj: any) => obj instanceof fabric.Rect
    );
    let selectionRect = "";
    if (rectangleIndex !== -1) {
  ...
  return (
    <div id="image_container">
      {removeBackgroundImageLoading && <Loader width="100%" height="100px" />}
      <Box
        style={{
          width: "100%",
          textAlign: "center",
          ...
          alignItems: "center",
          visibility:
            !selectedFile || removeBackgroundImageLoading
              ? "hidden"
              : "visible",
        }}
      >
